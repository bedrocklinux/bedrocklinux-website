...
~+Bedrock Linux~x lets users manage their own distro-blend on their computers, usually by mixing-in packaged components from readily existing linux distributions.
